/** Conjunto de ícones (Lucide-style), idêntico ao HTML de referência. */
...
const PATHS: Record<string, string> = {
  ...
  gavel:
    '<path d="m14 13-7 7"/><path d="m10 9 6 6"/><path d="M13 5 19 11"/><path d="m16 2 6 6-3 3-6-6z"/><path d="M3 21h8"/>',
  inbox:
